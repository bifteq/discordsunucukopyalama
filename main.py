mytitle = "Sunucu Backup Sistemi - Bifteq"
...
{Style.RESET_ALL}
{Fore.YELLOW}> Sürümü Geliştiren : bifteq ᴋᴜᴠᴀɪ#0326.{Style.RESET_ALL}
{Fore.YELLOW}> Daha detayli icerik icin : bifteq.3d.tc{Style.RESET_ALL}
...
guild_s = input('Kopyalanacak sunucu idi:\n >')
guild = input('Backup atacağınız sunucu id:\n >')
